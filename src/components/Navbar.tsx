...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[500] bg-background/95 backdrop-blur-sm border-b border-border/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24 md:h-28">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            {/* Blog */}
            <a
              href="https://earningmoneyusingai.com/"
              target="_blank"
          ...
          <div className="lg:hidden border-t border-border/50 bg-background">
            <div className="px-2 pt-2 pb-3 space-y-1 max-h-screen overflow-y-auto">
              ...
              <div className="space-y-1">
                <div className="px-4 py-3 text-base font-medium text-foreground">Services</div>
                {services.map((service, index) => (
                  <a
                    key={index}
                    href={service.href}
                    className="block px-8 py-2 rounded-lg text-sm text-muted-foreground hover:bg-accent"
                    onClick={() => {
                      playClickSound();
                      setIsMenuOpen(false);
                    }}
